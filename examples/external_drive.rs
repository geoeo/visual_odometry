...
fn main() {
    ...
    let (intensity_files, depth_files)
        = generate_runtime_intensity_depth_lists(image_folder_path,depth_folder_path,"1311868164.363181","png",1,10, max_diff_milliseconds);
