...
fn main() {
    ...
    let intensity_name = "1311868174.699578"; // max value should be 31280.0
    let image_format = "png";
    let depth_path = format!("images/depth/{}.{}",depth_name,image_format);
    let intensity_path = format!("images/depth/{}.{}",depth_name,image_format);
    let cv_image_16
    ...
    let image_8 = Image::from_cv_mat(cv_image_8,ImageFilter::None,false, ImageEncoding::U8;
